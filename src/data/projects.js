...
export const projects = [
  ...
  {
    id: 5,
    title: 'Bot de WhatsApp – Calificación de Leads',
    category: 'IA',
    description: 'Bot conversacional con IA que califica prospectos automáticamente, responde preguntas frecuentes y agenda citas por WhatsApp.',
    stack: ['n8n', 'Claude AI', 'WhatsApp API', 'Supabase'],
    url: '#',
    impact: 'Tiempo de respuesta reducido a segundos. Clientes atendidos 24/7.',
    img: null,
  },
];
